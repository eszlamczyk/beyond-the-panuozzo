...
export class InitBasicTables1770728533676 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_orders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "size" character varying NOT NULL, "userId" uuid, "orderId" uuid, "food_id" uuid, CONSTRAINT "PK_753da927c0c469cc6646133b213" PRIMARY KEY ("id"))`);

...
export class AddWishlist1770814059761 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "wishlist" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "rating" integer NOT NULL, "size" character varying NOT NULL, "foodId" uuid NOT NULL, "userId" uuid NOT NULL, "orderId" uuid NOT NULL, CONSTRAINT "CHK_1e57c5e826dd868ed462382645" CHECK ("rating" >= 1 AND "rating" <= 5), CONSTRAINT "PK_620bff4a240d66c357b5d820eaa" PRIMARY KEY ("id"))`);
